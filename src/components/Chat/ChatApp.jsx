...
import { MessageCircle, X, Minimize2, Maximize2, Send, Phone, Video, Info, ArrowLeft, Search, Users, Plus } from 'lucide-react';
              ...
              return (
                ...
                >
                  <div className={`max-w-md ${isOwnMessage ? 'order-2' : 'order-1'}`}>
                    ...
                    <div
                      className={`px-4 py-3 rounded-2xl text-sm transition-all duration-200 transform hover:scale-[1.02] ${
                        isOwnMessage
          ...
          <div className="p-4 border-t border-gray-200 bg-white">
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleSendMessage}
                disabled={!newMessage.trim()}
                className="p-3 bg-purple-600 text-white rounded-full hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-110 shadow-lg"
              >
                <Send className="h-4 w-4" />
              </button>
            </div>
